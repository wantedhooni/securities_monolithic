package com.revy.securities.domain.processor.account.impl;
...
public class AccountProcessorImpl implements AccountProcessor {
    ...
    @Transactional
    @Override
    public AccountResultDto.AccountInfo create(Long userId, AccountType accountType, Currency currency) {
        ...
        return mapper.convertAccountInfo(newAccount);
    }
...
//    }
    ...
    static class mapper {
        public static AccountResultDto.AccountInfo convertAccountInfo(Account newAccount) {
            return new AccountResultDto.AccountInfo(newAccount.getType(), newAccount.getAccountNo(),
